    ...
    return (
        <div className='socials-container relative'>
            <div className='flex space-x-8 mb-8 mt-16 justify-center'>
                <button className='mr-1 inline-flex items-center space-x-1 text-gray-300 transition duration-200'>
