            ...
            <main className='project-details'>
                <div className='details-container text-gray-100 mt-20'>
                    ...
                    <div className='flex mt-36 space-x-10'>
                        <div className='pt-20'>
                            <img className='mb-6 rounded' src={loginpage} />
                            <img className='mb-6 rounded' src={registerpage} />
                        </div>
                        <div className='w-5/7'>
                    ...
                    <div className='mt-36 space-x-10'>
                        <div>
                            <img className='my-14 h-full rounded-lg' src={createpost} />
                        </div>
                        <div>
                            <img className='rounded-lg' src={editpost} />
                        </div>
                    </div>
                        ...
                        <div>
                            <HashLink to="#projects" smooth>
                                <button className=' flex items-center justify-between space-x-2 project-cta'>
                                    ...
                                    <div className='header-cta'>Previous Project</div>
